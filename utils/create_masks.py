...
def shapes_to_label(img_shape, shapes, label_name_to_value, layer_order=None):
    ...
    Modified to add ability to sort by layer order. Important in our case where
    we want to ensure that NOTPV is always drawn after PV. 
...
def labelme_json_to_binary(json_file, mask_dir, label_name_to_value,
    ...
    mask representing the location of objects labelled in the image. Adds 
    ability to apply a layer order for overlapping polygons.
